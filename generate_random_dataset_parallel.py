...
BASE_OUTPUT_DIR = "pairwise_amg_500_and_750"  # Base directory for all outputs
LOG_DIR = "./logs"
...
GENERATION_SOURCE: Union[int, List[int], str, tuple] = "41-60"  # Single audio for spectral analysis

BATCH_SIZE = 100                       # Number of audio to generate per prompt/cluster
MINI_BATCH_SIZE = 2                  # Number of audio to generate at once (reduces VRAM usage)
